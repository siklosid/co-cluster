#ifndef __L2_SIMILARITY_H
#define __L2_SIMILARITY_H
...
class L2Similarity : public SimilarityBase {
 public:
  L2Similarity(Data<double> *data, bool do_bicluster) : SimilarityBase(data, do_bicluster) {}
  ~L2Similarity();
