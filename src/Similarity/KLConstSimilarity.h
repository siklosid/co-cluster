#ifndef __KL_CONST_SIMILARITY_H
#define __KL_CONST_SIMILARITY_H
...
class KLConstSimilarity : public SimilarityBase {

 public:
  KLConstSimilarity(Data<double> *data, bool do_bicluster) : SimilarityBase(data, do_bicluster) {}
  ~KLConstSimilarity();
 ...
 private:
  ...
  vector< KLConstClusterInfo > *tmp_clust_info_;
  ...
  LocalInfo<KLConstItemInfo, KLConstClusterInfo, KLCoClusterInfo> *local_info_;

  Mutex data_mutex_;
};


#endif // __KL_CONST_SIMILARITY_H
